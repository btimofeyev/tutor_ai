            ...
            variables: {
              default: {
                colors: {
                  ...
                  brandButtonBackground: '#FFE6A7',
                  defaultButtonBackground: '#FFE6A7',
                  defaultButtonBackgroundHover: '#FFD993',
                  defaultButtonText: '#374151',
                  defaultButtonBorder: '#FFE6A7',
                  defaultButtonBorderHover: '#FFD993',
                  inputBackground: 'var(--background-card)',
                  inputBorder: 'var(--border-input)',
                  inputBorderHover: 'var(--border-input)',
                  inputBorderFocus: '#FFE6A7',
