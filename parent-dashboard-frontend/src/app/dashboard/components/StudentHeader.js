    ...
    <div className="mb-8 p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
      <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4">
        ...
        <div className="flex flex-col items-start sm:items-end w-full sm:w-auto">
          ...
          <Link
            ...
            className="flex items-center text-xs px-3 py-1.5 bg-indigo-100 text-indigo-700 hover:bg-indigo-200 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center pt-4 border-t border-gray-200">
        <div className="bg-blue-50 p-3 rounded-lg">
          <div className="text-xs uppercase text-blue-600 tracking-wider font-semibold">
            Total Items
          </div>
        ...
        <div className="bg-yellow-50 p-3 rounded-lg">
          <div className="text-xs uppercase text-yellow-600 tracking-wider font-semibold">
            Due Soon (7d)
          </div>
        ...
        <div className="bg-red-50 p-3 rounded-lg">
          <div className="text-xs uppercase text-red-600 tracking-wider font-semibold">
            Overdue
          </div>
        ...
        <div className="bg-green-50 p-3 rounded-lg">
          <div className="text-xs uppercase text-green-600 tracking-wider font-semibold">
            Completion
          </div>
          <div className="text-2xl font-bold text-green-800 mt-1">
            {dashboardStats.overallCompletionPercent}%
          </div>
        </div>
      </div>
    </div>
